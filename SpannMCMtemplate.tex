...
\begin{itemize}
\item \textbf{STATE ASSUMPTION 1}.  Add one-two sentences describing and justifying your assumption.
\item \textbf{ASSUMPTION 2}.  Describe/Justify.
\item \textbf{ASSUMPTION 3}.  Describe/Justify.
%%%Add more items as needed
\end{itemize}
