...
\begin{itemize}
\item \textbf{The initial search domain is a $500$km by $300$km rectangle of unobstructed ocean.} This rectangle would cover the whole uncertainty range based on 
...
\item \textbf{The coarse search cell is assumed to be $17$km by $15$km.} This is based on computational issues. Further refinements are simply an exercise for the computers.
...
\item \textbf{Search agents all have a lateral range function of a bivariate Gaussian as a function of their type, altitude, and speed.}
...
\item \textbf{The search agents have perfect knowledge of local drift direction.} Modern softwares used by professional SAR entities (e.g. SARPOS by U.S. Coastal Guards) all have existing database to accommodate real-time data.
%%%Add more items as needed
\end{itemize}
