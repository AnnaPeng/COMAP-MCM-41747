...
\item \textbf{The crashed/force landed aircraft debris is assumed to be remain close to each other and floating at all time.} The assumption is that not enough time have passed for important targets (e.g. lifeboats) 
